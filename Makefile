...
main: main.c converter.h converter.c point.h point.c
	clang -ggdb3 -O0 -std=c99 -Wall -Werror -o main main.c converter.c point.c /usr/local/Cellar/gdal/1.11.2_1/lib/libgdal.1.dylib -lconfig
